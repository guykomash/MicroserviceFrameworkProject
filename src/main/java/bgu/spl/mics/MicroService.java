...
public abstract class MicroService implements Runnable {
    ...
    protected HashMap<Class<? extends Message>, Callback> functionMap;
    ...
    public MicroService(String name) {
        ...
        functionMap = new HashMap<Class<? extends Message>, Callback>();
    }
    ...
    public final void run() {
        ...
        // register MS to the bus.
        bus.register(this);

        // initialize needs to be implemented by Microservice class extenders...
        initialize();

        while (!terminated) {
            // Message loop
            try {
                // reminder: awaitMessage uses queue.take() which is blocking.
                Message message = bus.awaitMessage(this);

                //message fetched. invoke the appropriate callback function from functionMap.
                functionMap.get(message.getClass()).call(message);

            } catch (InterruptedException e) {
            }
        }

        // unregister microservice upon termination.
        bus.unregister(this);
    }
}